...
-- Restart
    ...
    awful.key({ modkey }, "Left", function() os.execute("xdotool mousemove_relative -- -50 0") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey }, "Down", function() os.execute("xdotool mousemove_relative -- 0 50") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey }, "Up", function() os.execute("xdotool mousemove_relative -- 0 -50") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey }, "Right", function() os.execute("xdotool mousemove_relative -- 50 0") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey, "Shift" }, "Left", function() os.execute("xdotool mousemove_relative -- -5 0") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey, "Shift" }, "Down", function() os.execute("xdotool mousemove_relative -- 0 5") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey, "Shift" }, "Up", function() os.execute("xdotool mousemove_relative -- 0 -5") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey, "Shift" }, "Right", function() os.execute("xdotool mousemove_relative -- 5 0") end,
        { description = "Move cursor", group = "client" }),
    awful.key({ modkey }, "[", function() os.execute("xdotool click 1") end,
        { description = "Left click cursor", group = "client" }),
    awful.key({ modkey }, "]", function() os.execute("xdotool click 3") end,
...
-- Floating
    ...
    -- Magnify
    awful.key({ modkey, "Shift" }, "m", magnify_client,
