...
hl.animation({ leaf = "windows", enabled = true, speed = 4.8, bezier = "quick" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.1, bezier = "quick", style = "popin 94%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.5, bezier = "quick", style = "popin 94%" })
hl.animation({ leaf = "fade", enabled = true, speed = 3, bezier = "quick" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 3.5, bezier = "quick", style = "slide" })
...
bind(mod .. " + R", hl.dsp.exec_cmd("rofi -terminal alacritty -show drun"))
bind(mod .. " + L", hl.dsp.exec_cmd("hyprlock"))
bind(mod .. " + P", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | satty --filename -"))
